function [transfer] = postProcessLT( time, states, propFunction, pm )
...
for indt = 1:length(time)
    ...
    [~, thrustRTN(indt,:)] = propFunction( time(indt), states(indt,:)', [ pm.muScl, pm.TmaxScl, pm.IspScl, pm.g0Scl, pm.rho ] );
