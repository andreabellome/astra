...
t0 = date2mjd2000([2005 1 1 0 0 0]); % --> initial date range for launch (MJD2000)
...
% --> specify if some defects need to increase or decrease the infinity velocity and on which leg
INPUT.decrease       = 1;
INPUT.vilt_seq_index = [4 5 6];
INPUT.TOF_LIM        = [ 50 500; 100 500; 50 400; 50 300; 50 400; 100 600 ];
